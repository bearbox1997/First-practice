<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@page import="Works.searchInterface,Entities.modlePaysalarys,java.util.ArrayList,java.util.List,Services.Delete"%>
<!-- 修改0：:类名 -->
<!DOCTYPE html>
<html ng-app="app">
...
<body style="margin-left: 17%;margin-right: 2%;">
    <div class="box">
        <button value="paysalarys_copy1" class="tableName" hidden>表名</button> <!-- 修改1：employees_copy1 -->
        ...
        <button value="7" class="columnNum" hidden>表名</button> <!-- 修改2：13 -->
        <div class="title">薪水表</div>
        <div class="content">
            <!--搜索输入框及查询、重置按钮-->
                                ...
                                <table id="xztb" class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="tb_bg"><label for="">
                                                    <font style="font-size: 14px; color: red;">*</font>领薪人编号
                                                </label>
                                            </td>
                                            <td><input class="pId notEdit changeEdit" type="text" placeholder="请输入领薪人编号" maxlength="6" /></td>
                                        </tr>
                                        <tr>
                                            <td class="tb_bg"><label for="">
                                                    <font style="font-size: 14px; color: red;">*</font>领薪人名称
                                                </label>
                                            </td>
                                            <td><input class="pName" type="text" placeholder="请输入领薪人姓名" maxlength="20" /></td>
                                            <td class="tb_bg"><label for="">
                                                    <font style="font-size: 14px; color: red;">*</font>薪水
                                                </label>
                                            </td>
                                            <td><input class="pSalary" type="text" placeholder="薪水请更新后查看" maxlength="20" value="0" /></td>
                                        </tr>
                                        <tr>
                                            <td class="tb_bg"><label for="">
                                            ...
                                            <td>
                                                <div class=" c-datepicker-single-editor J-datepicker-day mt10">
                                                    <input class="pTimeStart" type="text" autocomplete="off" name="" placeholder="选择日期" class=" c-datepicker-data-input only-date" value="">
                                                </div>
                                            </td>
                                            <td class="tb_bg"><label for="">
                                            ...
                                            <td>
                                                <div class=" c-datepicker-single-editor J-datepicker-day mt10">
                                                    <input class="pTimeEnd" type="text" autocomplete="off" name="" placeholder="选择日期" class=" c-datepicker-data-input only-date" value="">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="tb_bg"><label for="">
                                                    <font style="font-size: 14px; color: red;">*</font>有效工时
                                                </label>
                                            </td>
                                            <td><input class="pName" type="text" placeholder="有效工时请更新后查看" maxlength="20" value="0" /></td>
                                        </tr>
                                        <!------------------------------------             修改3：结束             --------------------------------->
                                    </tbody>
                                </table>
