<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@page import="Works.searchInterface,Entities.modleRepaircards,java.util.ArrayList,java.util.List,Services.Delete"%>
<!-- 修改0：:类名 -->
<!DOCTYPE html>
<html ng-app="app">
...
<body style="margin-left: 17%;margin-right: 2%;">
    <div class="box">
        <button value="repaircards_copy1" class="tableName" hidden>表名</button> <!-- 修改1：employees_copy1 -->
        <button value="rrInnerId" class="idName" hidden>表名</button> <!-- 修改2：eId -->
        <button value="rrInnerId" class="lastIdName" hidden>表名</button> <!-- 添加信息的自增Id -->
        <button value="5" class="columnNum" hidden>表名</button> <!-- 修改2：13 -->
        <div class="title">补卡表</div>
        <div class="content">
            <!--搜索输入框及查询、重置按钮-->
                                ...
                                <table id="xztb" class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input class="rrInnerId  notEdit increaseId" id="increaseId" type="number" placeholder="请输入ID" maxlength="6" /></td>
                                            <td class="tb_bg"><label for="">
                                                    <font style="font-size: 14px; color: red;">*</font>补卡人编号
                                                </label>
                                            </td>
                                            <td><input class="rrId notEdit changeEdit" type="text" placeholder="请输入补卡人编号" maxlength="6" /></td>
                                        </tr>
                                        <tr>
                                            <td class="tb_bg"><label for="">
                                                    <font style="font-size: 14px; color: red;">*</font>补卡人名称
                                                </label>
                                            </td>
                                            <td><input class="rrName" type="text" placeholder="请输入补卡人姓名" maxlength="20" /></td>
                                            <td class="tb_bg"><label for="">
                                            ...
                                            <td>
                                                <div class="J-datepickerTime-single">
                                                    <input class="rrDateTime" type="text" autocomplete="off" name="" placeholder="选择日期" maxlength="5" class=" c-datepicker-data-input" value="">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="tb_bg"><label for="">
                                                    <font style="font-size: 14px; color: red;">*</font>补卡原因
                                                </label>
                                            </td>
                                            <td><input class="rrDesc" type="text" placeholder="请输入补卡原因" maxlength="20" /></td>
                                        </tr>
