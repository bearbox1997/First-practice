<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@page import="Works.searchInterface,Entities.modleDepartments,java.util.ArrayList,java.util.List,Services.Delete"%>
<!-- 修改0：:类名 -->
<!DOCTYPE html>
<html>
...
<body style="margin-left: 17%;margin-right: 2%;">
    <div class="box">
        <button value="departments_copy1" class="tableName" hidden>表名</button> <!-- 修改1：employees_copy1 -->
        <button value="dInnerId" class="idName" hidden>表名</button> <!-- 修改2：eId -->
        <button value="dInnerId" class="lastIdName" hidden>表名</button> <!-- 添加信息的自增Id -->
        <button value="7" class="columnNum" hidden>表名</button> <!-- 修改2：13 -->
        <div class="title">部门表</div>
        <div class="content">
            <!--搜索输入框及查询、重置按钮-->
                                ...
                                <table id="xztb" class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input class="dInnerId  notEdit increaseId" type="number" placeholder="请输入ID" maxlength="6" /></td>
                                            <td class="tb_bg"><label for="">
                                                    <font style="font-size: 14px; color: red;">*</font>部门编号
                                                </label>
                                            </td>
                                            <td><input class="dId notEdit changeEdit" type="text" placeholder="请输入部门编号" maxlength="6" /></td>
                                        </tr>
                                        <tr>
                                            <td class="tb_bg"><label for="">
                                                    <font style="font-size: 14px; color: red;">*</font>部门名称
                                                </label>
                                            </td>
                                            <td><input class="dName" type="text" placeholder="请输入部门名称" maxlength="6" /></td>
                                            <td class="tb_bg"><label for=""><font style="font-size: 14px; color: red;">*</font>部门职责</label>
                                            </td>
                                            <td><input class="dDuty" type="text" placeholder="请输入部门职责" /></td>
                                        </tr>
                                        <tr>
                                            <td class="tb_bg"><label for="">
                                                    <font style="font-size: 14px; color: red;">*</font>上级部门
                                                </label>
                                            </td>
                                            <td><input class="dSuper" type="text" placeholder="请输入上级部门" maxlength="6" /></td>
                                            <td class="tb_bg"><label for="">备注</label>
                                            </td>
                                            <td><input class="dDesc" type="text" placeholder="请输入备注" /></td>
                                        </tr>
                                        <tr>
                                            <td class="tb_bg jParent">
                                                <font style="font-size: 14px; color: red;">*</font><label for="">部门负责人</label>
                                            </td>
                                            <td>
